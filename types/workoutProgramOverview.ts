...
export const workoutProgramOverviewSchema = z.object({
  opening: z
    .string()
    .describe(
      'response of what user chat before, for example: "Great! I have all the information I need to create a overview workout program for you."',
    ),
          ...
          .array(
            z.object({
              ...
              list: z
                ...
                .describe('list of example of other program')
                .optional(),
            }),
          )
          .describe(
            'example of other program if any, for example schedule meal or list meal, add list if data is list type, if not just use description',
          )
          .optional(),
      }),
    )
    .describe(
      'other program that fit on user, ' +
